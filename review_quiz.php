...
// Use the inquiz layout instead of incourse
$PAGE->set_pagelayout('inquiz');
...
// Original $PAGE->set_heading($attemptobj->get_course()->fullname);
$PAGE->set_heading($attemptobj->get_quiz_name());
